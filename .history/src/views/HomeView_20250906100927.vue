...
const addExistingMarker = (lieu: any) => {
  ...
  const popupContent = `
    <div class="darkMode" style="min-width:250px;font-family:system-ui;">
      <h3 class="darkMode" style="margin-bottom:8px;color:#1f2937;font-size:16px;">${
        lieu.nom
      }</h3>
      <p class="darkMode" style="margin-bottom:8px;color:#6b7280;font-size:13px;line-height:1.4;">${
        lieu.description || ""
      }</p>
      <div class="darkMode" style="font-size:11px;color:#9ca3af;margin-bottom:10px;">
      ...
      <div class="darkMode"  style="display:flex;gap:8px;">
